                                ...
                                <form onSubmit={::this.login}>
                                    <div className="panel panel-body login-form">
                                        <div className="text-center">
                                            ...
                                            <h5 className="content-group">Login to your account
                                                <small className="display-block">Enter your credentials below</small>
                                            </h5>
                                        </div>
                                        <div className="form-group has-feedback has-feedback-left">
                                            <input type="text" onChange={::this.handleValue} name="username"
                                        ...
                                        <div className="form-group has-feedback has-feedback-left">
                                            <input type="password" onChange={::this.handleValue} name="password"
