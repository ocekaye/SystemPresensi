...
@withRouter
@connect((state) => state)
export default class TambahSiswa extends React.Component{
  ...
  render(){
    ...
    return(
      <div className="content-wrapper col-lg-12">
        <PageHeader icon="icon-pencil5 position-left" text1="Tambah Siswa"/>
              ...
              <div className="panel-body">
                ...
                <form className="form-horizontal" action="#">
                  <fieldset className="content-group">
                    <legend className="text-bold">Tambahkan Data Siswa</legend>

                    <div className="form-group">
                      <label className="control-label col-lg-2">Nama Siswa</label>
                      <div className="col-lg-10">
                        <input type="text" name="siswa" onChange={::this.handleValue} className="form-control"/>
                      </div>
                    </div>
